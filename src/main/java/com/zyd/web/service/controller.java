...
public class controller extends ServiceBase {
    /**
     * method: get
     * description: perform various control functions
     * parameters: action, 'ClearAllData' will clear all data from the system, only used for test. 
     */
    @Override
    public void get(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("ClearAllData".equals(action)) {
            ...
            CrawlerManager.getInstance().clearAll();
