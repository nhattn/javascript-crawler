...
zyd.api.config = {
    PageSize : 50,
    layerInfo : [ [ 'com.zuiyidong.layer.wifi', 'wifi' ], [ 'com.zuiyidong.layer.busstation', 'busstation' ],
            [ 'com.zuiyidong.layer.busline', 'busline' ], [ 'com.zuiyidong.layer.restaurant', 'restaurant' ], [ 'House', 'House' ] ],
    init : function() {
        this.layerMapping = {
