...
public class TestAuth extends TestCase {
    ...
    static class SimpleTestThread implements Runnable {
        ...
        public static void auth() throws Exception {
            ...
            params.put("clientId", TestAuth.clientId);
            params.put("clientKey", TestAuth.clientKey);
            String s = HttpTestUtil.httpPostForString("http://" + TestAuth.host + "/service/auth", params);
        ...
        public static void query() throws Exception {
            ...
            params.put("clientId", TestAuth.clientId);
            String s = HttpTestUtil.httpGetForString("http://" + TestAuth.host + "/service/api", params);
