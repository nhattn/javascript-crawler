...
public class CrawlerManager {
    ...
    public void setJsonMapper(JsonMapper jm) {
        this.jsonMapper = jm;
    }

    public void setSiteManager(SiteManager sm) {
        this.siteManager = sm;
    }
    ...
    /**
     * processes a request with a book list, the request should contain "data"
     * as parameter, with a json string, containing a list of books. These books
     * should not contain any chapter information, or these chapters will be
     * ignored.
     * 
     * @param s
     *            a json object posted from browser
    ...
    public int processBookList(String jsonBookListString, String fromUrl) {
        List<Book> books = jsonMapper.parseBookList(jsonBookListString), booksWithId = new ArrayList<Book>();
    ...
    /**
     * process a request with a book, the reuqest should conain "data" as
     * parameter, with a json string, containing a list of chapters or more
     * information of the book. the book should at least have an author and
     * name. or it will be ignored.
     * 
     * @param s
    ...
    public boolean processBook(String jsonBookListString, String fromUrl) {
        Book book = jsonMapper.parseBook(jsonBookListString), bookWithId = null;
