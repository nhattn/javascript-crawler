...
public class TestObjectHelper extends TestCase {
    public static Object[] list = new Object[] { 
        new Object[] { "1-2", Types.INTEGER, 1, 2 }, 
        new Object[] { "1-", Types.INTEGER, 1, null}, 
        new Object[] { "-2", Types.INTEGER, null, 2 },
        new Object[] { "2", Types.INTEGER, 2 },
        
        new Object[] { "11.1-22.2", Types.FLOAT, 11.1f, 22.2f },
        new Object[] { "11.1-", Types.FLOAT, 11.1f, null },
        new Object[] { "-22.2", Types.FLOAT, null, 22.2f },
        new Object[] { "11.1", Types.FLOAT, 11.1f},
        
        new Object[] { "aa-zz", Types.VARCHAR, "aa", "zz"},
        new Object[] { "-zz", Types.VARCHAR, null, "zz"},
        new Object[] { "aa-", Types.VARCHAR, "aa", null},
    ...
    public static Object[] dates = new Object[] { 
        new Object[] { "2000-01-01/2000-12-12", Types.DATE, getDate(2000, 1, 1), getDate(2000, 12, 12) },
        new Object[] { "/2000-12-12", Types.DATE, null, getDate(2000, 12, 12) },
        new Object[] { "2000-01-01/", Types.DATE, getDate(2000, 1, 1), null },
